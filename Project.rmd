...
anova_test <- aov(resale_price ~ is_1_room + 
                    ...
                    is_west +
                    floor_area_sqm_std +
                    remaining_lease_std, housing)
anova_test

# F-test on each features with 2 levels
is_2_room <- var.test(resale_price ~ is_1_room, housing, 
         alternative = "two.sided")
is_2_room <- var.test(resale_price ~ is_2_room, housing, 
         alternative = "two.sided")
is_3_room <- var.test(resale_price ~ is_3_room, housing, 
         alternative = "two.sided")
is_4_room <- var.test(resale_price ~ is_4_room, housing, 
         alternative = "two.sided")
is_5_room <- var.test(resale_price ~ is_5_room, housing, 
         alternative = "two.sided")
is_executive <- var.test(resale_price ~ is_executive, housing, 
         alternative = "two.sided")
is_north <- var.test(resale_price ~ is_north, housing, 
         alternative = "two.sided")
is_south <- var.test(resale_price ~ is_south, housing, 
         alternative = "two.sided")
is_west <- var.test(resale_price ~ is_west, housing, 
         alternative = "two.sided")
