...
#Corresponding indices of the non-zero coefficients
coef_min_lasso
```
...
# floor_area_sqm <- var.test(resale_price ~ floor_area_sqm, housing,
#    alternative = "two.sided")
# remaining_lease <- var.test(resale_price ~ remaining_lease, housing,
#    alternative = "two.sided")
