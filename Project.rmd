...
p1 <- ggplot(sample_housing) + 
  geom_point(aes(x=floor_area_sqm_std,y=resale_price),size=0.5,position="identity") + 
  theme_minimal()
p2 <- ggplot(sample_housing) + 
  geom_point(aes(x=floor_area_sqm_std,y=log(resale_price)),size=0.5,position="identity") + 
  theme_minimal()
